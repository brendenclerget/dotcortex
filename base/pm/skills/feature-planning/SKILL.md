...
Task Breakdown (docs/tasks/feature-name-tasks.md)
  ↓
Tickets ({{TASKS_DIR}}/{{TICKET_PREFIX}}-XXX-feature-name.md)
```
...
**Author**: [Name]
**Last Updated**: [Date]
**Tickets**: {{TICKET_PREFIX}}-XXX, {{TICKET_PREFIX}}-YYY
...
In ticket files ({{TICKET_PREFIX}}-XXX.md), add:
```markdown
